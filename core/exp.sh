...
python Cross_Validation.py --status "o" --task "next_timestamp" --contextual_info False --num_epochs 10 --batch_size 256  --data_set "bpi_2013_closed_problems.xes.gz_Train_All" --p_data_set "bpi_2013_closed_problems.xes.gz_Train_log_2" --data_dir "../samples/" --test_data_set "bpi_2013_closed_problems.xes.gz_Test" --test_data_dir "../samples/" --checkpoint_dir "./checkpoints/" --control_flow_p True --time_p True --resource_p False --data_p False --transition False --cross_number 5

python Cross_Validation.py --status "p" --task "next_timestamp" --contextual_info False --num_epochs 10 --batch_size 256  --data_set "bpi_2013_closed_problems.xes.gz_Train_All" --p_data_set "bpi_2013_closed_problems.xes.gz_Train_log_2" --data_dir "../samples/" --test_data_set "bpi_2013_closed_problems.xes.gz_Test" --test_data_dir "../samples/" --checkpoint_dir "./checkpoints/" --control_flow_p True --time_p True --resource_p False --data_p False --transition False --cross_number 5
